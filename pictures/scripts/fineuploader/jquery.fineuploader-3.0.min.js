...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"სურათის ატვირთვა",cancelButton:"გათიშვა",retryButton:"თავიდან ცდა",failUpload:"ვერ აიტვირთა",dragZone:"ასატვირთად ფაილი ჩადეთ აქ",formatProgress:"{percent}% / {total_size}",waitingForResponse:"მიმდინარეობს ატვირთვა..."},template:'<div class="qq-uploader">'+(!this._options.dragAndDrop||!this._options.dragAndDrop.disableDefaultDropzone?
