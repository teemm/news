...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'სურათის ატვირთვა',
            cancelButton: 'გათიშვა',
            retryButton: 'თავიდან ცდა',
            failUpload: 'სურათი ვერ აიტვირთა',
            dragZone: 'ჩაყარეთ ფაილები აქ',
            formatProgress: "{percent}% / {total_size}",
            waitingForResponse: "მიმდინარეობს ატვირთვა..."
        },
        ...
        failedUploadTextDisplay: {
            ...
            maxChars: 50,
            responseProperty: 'შეცდომა',
            enableTooltip: true
        },
        messages: {
            tooManyFilesError: "შესაძლებელია 1 ფაილის ჩაგდება"
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "თავიდან ცდა {retryNum}/{maxAuto}...",
            showButton: false
        },
