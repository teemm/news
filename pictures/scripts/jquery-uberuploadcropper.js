	...
	$.fn.uberuploadcropper = function(options){
		...
		var allUploadsComplete = function(){
			...
			$.each(imgdata,function(i,obj){
				var btn = {};
				var str = '<div style="text-align: center;"><img src="'+base_url+'/pictures/'+ options.folder + obj.filename +'?d='+ (new Date()).getTime() +'" class="ubercropimage" id="ubercropimage_'+ i +'" style="margin: 0 auto;" /></div>'+
